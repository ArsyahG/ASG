...
gg.alert("@OrangBiasa4")
gg.toast("www.youtube.com/c/ArsyahG")
HOME = 1
function HOME()
  HM = gg.choice({
    "\226\158\168\239\184\143 BYPASS ",
    "1.\226\156\168\239\184\143 Wallhack ",
    "2.\226\156\168\239\184\143 Magic bullet ",
    "3.\226\156\168\239\184\143 Crystal ",
    "4.\226\156\168\239\184\143 Auto kenai ",
    "5.\226\156\168\239\184\143 Aim Bot ",
    "6.\226\156\168\239\184\143 No Recoil ",
    "7.\226\156\168\239\184\143 High View\n(SitDown On Scope) ",
	"8.\226\156\168\239\184\143 Off High View ",
	"9.\226\156\168\239\184\143 Drive Through Wall ",
	"10.\226\156\168\239\184\143 Drive In Water ",
	"\226\156\179\239\184\143 My Contact \226\156\179\239\184\143",
	"\226\158\168\239\184\143 EXIT "
	}, nil, [[
Free Script PUBG mobile
Youtube: Arsyah G
Telegram: @OrangBias4
Instagram: @arsyah_g]])
if HM == 1 then
...
function BYPASS()
  ...
  gg.searchNumber("1.1D;1.4D:2::10", gg.TYPE_DOUBLE, false, gg.SIGN_EQUAL, 0, -1)
  gg.clearResults(850)
  gg.alert("BYPASS 100% diaktifkan")
end
function M1()
 gg.clearResults()
...
gg.editAll("800", gg.TYPE_FLOAT)
gg.clearResults()
gg.toast("Bakso bulat telah aktif")
end
function M3()
     gg.clearResults()
    gg.setRanges(gg.REGION_BAD)
...
function EXIT()
  print(os.date("Free Script PUBG MOBILE"))
